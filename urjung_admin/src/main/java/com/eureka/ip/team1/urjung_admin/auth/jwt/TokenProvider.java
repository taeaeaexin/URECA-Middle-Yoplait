package com.eureka.ip.team1.urjung_admin.auth.jwt;
...
import com.eureka.ip.team1.urjung_admin.auth.config.AdminUserDetailsService;
...
public class TokenProvider {
	...
	public Authentication getAuthentication(String token) {
		UserDetails userDetails = adminUserDetailsService.loadUserByUsername(this.getUsernameFromToken(token));
