...
import com.eureka.ip.team1.urjung_admin.auth.config.AdminAuthenticationEntryPoint;
import com.eureka.ip.team1.urjung_admin.auth.config.SecurityConfig;
import com.eureka.ip.team1.urjung_admin.auth.controller.AuthController;
...
public class AuthControllerTest {
    ...
    void signup_Success() throws Exception {
        ...
        when(authService.signup(any(AdminDto.class))).thenReturn(apiResponse);
